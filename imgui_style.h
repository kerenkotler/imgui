...
namespace ImGui {
    ...
    template <>
        bool applyStyle<IMGUI_STYLE_DEFAULT>() {
            ...
            style = defaultStyle;
            style.Colors[ImGuiCol_Border].w = 0.10f;
    ...
    template <>
        bool applyStyle<IMGUI_STYLE_TEAL_AND_ORANGE>() {
            ...
            style.Colors[ImGuiCol_WindowBg]              = ImVec4(0.12f, 0.16f, 0.16f, 0.94f);
            style.Colors[ImGuiCol_ChildWindowBg]         = ImVec4(0.07f, 0.07f, 0.09f, 1.00f);
            style.Colors[ImGuiCol_PopupBg]               = ImVec4(0.07f, 0.07f, 0.09f, 1.00f);
            style.Colors[ImGuiCol_Border]                = ImVec4(0.78f, 0.51f, 0.00f, 0.10f);
